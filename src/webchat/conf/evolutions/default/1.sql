...
alter table message add constraint fk_message_uid_2 foreign key (uid_id) references user (id) on delete restrict on update restrict;
create index ix_message_uid_2 on message (uid_id);
